...
const socials = [
  ...
  {
  name: "Medium",
  link: "https://medium.com/@achomaduonyinye",
  icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42c1.87 0 3.38 2.88 3.38 6.42M24 12c0 2.98-.75 5.38-1.67 5.38-.92 0-1.67-2.4-1.67-5.38s.75-5.38 1.67-5.38c.92 0 1.67 2.4 1.67 5.38"/></svg>',
},
  {
    name: "X",
...
const projects = [
  ...
  {
   name: "Ng Service - Job Marketplace",
  description: "A comprehensive job search and booking platform with real-time notifications, automated job approvals, and seamless vendor-client communication through integrated dashboards.",
    image: "/ttt.png",
    githubLink: "https://github.com/onyillto/ngbuka-web",
    liveLink: "https://ng-service-sable.vercel.app/",
  },
  {
